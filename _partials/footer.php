<footer class="bg-dark position-relative overflow-hidden pb-0 pt-6 pt-lg-8" data-bs-theme="dark">
	...
	<div class="container position-relative mt-5">
		<div class="row g-4 justify-content-between">
			...
			<div class="col-lg-3">
				...
				<a class="me-0" href="index.html">
					<img class="light-mode-item h-40px" src="assets/images/logo/LOGO-ERATIS2.png" alt="logo">
					<img class="dark-mode-item h-40px" src="assets/images/logo/LOGO-ERATIS-BL2.png" alt="logo">
				</a>

				<p class="mt-4 mb-2">Société du Groupe SINNE</p>
			</div>
			<!-- Widget 1 END -->
			...
			<div class="col-lg-8 col-xxl-7">
				<div class="row g-4">
					...
					<div class="col-6 col-md-4">
						<h6 class="mb-2 mb-md-4">Liens</h6>
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link" href="contact.php">Contactez nous</a></li>
							<li class="nav-item"><a class="nav-link" href="societe-recrutement.php">Nous rejoindre</a></li>
						</ul>
					</div>

					<!-- Link block -->
					<div class="col-6 col-md-4">
						<h6 class="mb-2 mb-md-4">Communication</h6>
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0" 	href="mentions.php">Mentions légales</a></li>
							<li class="nav-item"><a class="nav-link" 		href="societe-index.php">Société</a></li>
					...
					<div class="col-md-4">
						...
						<ul class="list-inline mb-0 mt-3">
							<li class="list-inline-item"><i class="fa-solid fa-phone"></i> | 01 30 30 23 30 </li>
							<li class="list-inline-item"><i class="fa-regular fa-envelope"></i> | contact@eratis.com </li>
						</ul>
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
			<!-- copyright text -->
			<div class="text-body"> Copyrights © 1995 - <?php echo date('Y') ?> ERATIS. Développé avec <i class="fa-solid fa-heart"></i>, beaucoup de <i class="fa-solid fa-mug-hot"></i> et quelques <i class="fa-solid fa-beer-mug-empty"></i> | <a href="index.php" class="text-body text-primary-hover" target="_blank">Guillaume.C - SCS/ERATIS</a>. </div>
			<!-- copyright links-->
			<!-- Language selector -->
			<div class="dropdown dropup text-center text-md-end mt-3 mt-md-0">
				<a class="dropdown-toggle btn btn-sm btn-light mb-0" href="#" role="button" id="languageSwitcher" data-bs-toggle="dropdown" aria-expanded="false">
					<i class="fas fa-globe me-2"></i>Langage
				</a>
